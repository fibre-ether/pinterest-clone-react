...
function Card(props) {
    return (
        <div className="group-outer my-3 flex m-1 shadow-xl rounded-3xl w-40 md:w-42 xl:w-56">
            <div className="w-full relative h-64 rounded-3xl overflow-hidden sm:h-72 md:h-80 xl:96">
                ...
                <p className="absolute bottom-4 overflow-hidden text-white px-4 font-bold text-xs top-20 md:top-32 md:text-base overflow-y-auto">{props.desc}</p>
